...
let createCPUModule = () => {
  ...
  let addHTML = (admin) => {
    ...
    let htmlGraph = '<div class="col-sm" style="border: 1px solid lightgray; height: 300px; width: 300px; padding-bottom: 30px;"><div id="cpugraphtitle">CPU Graph</div><canvas id="cpugraph"></canvas></div>'
    if ($('#graphs').length) {
